...
def handle_message(event):
    ...
    #luar ITB messages
    elif ('9' in msg) or ('cisitu' in msg) or ('Cisitu' in msg):
        line_bot_api.reply_message(
            event.reply_token,
