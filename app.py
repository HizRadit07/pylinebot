...
def handle_message(event):
    ...
    elif ('Labtek 5' in msg) or ('Labtek V' in msg) or ('LABTEK 5' in msg) or ('LABTEK V' in msg):
        line_bot_api.reply_message(
            event.reply_token, 
    ...
    elif ('GKUT' in msg) or ('Gkut' in msg) or ('gkut' in msg):
        line_bot_api.reply_message(
            event.reply_token, 
            TextSendMessage(text="List tempat fotokopi di GKUT\n\n1. GKUT LT 1\nJUAL LENGKAP\nJam operasional: 09.00 - 15.00"))
    elif ('Labtek 8' in msg) or ('Labtek VIII' in msg) or ('LABTEK 8' in msg) or ('LABTEK VIII' in msg):
        line_bot_api.reply_message(
            event.reply_token, 
            TextSendMessage(text="List tempat fotokopi di LABTEK VIII\n\n1. LABTEK VIII LT BASEMENT\nHANYA FOTOKOPI, PRINT\nJam operasional: 09.00-15.00"))
    elif ('Labtek biru' in msg) or ('labtek biru' in msg):
        line_bot_api.reply_message(
            event.reply_token,
            TextSendMessage(text="List tempat fotokopi di Labtek biru\n\n1. LABTEK BIRU LT 1\nJUAL LENGKAP\nJam operasional: 09.00-16.00"))
    elif ('sbm' in msg) or ('SBM' in msg) or ('Sbm' in msg):
        line_bot_api.reply_message(
            event.reply_token,
            TextSendMessage(text="List tempat fotokopi di SBM\n\n1. SBM LT 2\nJUAL LENGKAP\nJam operasional: 09.00-15.00"))
    elif ('ITB Press' in msg) or ('Itb press' in msg) or ('itb press' in msg):
         line_bot_api.reply_message(
            event.reply_token,
    ...
    elif ('Tubis' in msg) or ('tubis' in msg) or ('Tubagus Ismail' in msg) or ('tubagus ismail' in msg) or ('Tubagus ismail' in msg):
        line_bot_api.reply_message(
            event.reply_token,
