...
def handle_message(event):
    ...
    elif (msg=='10') or (msg=='du') or (msg=='dipatiukur'):
        line_bot_api.reply_message(
            event.reply_token,
    ...
    elif (msg=='11') or (msg=='tubis') or (msg=='tubagus ismail'):
        line_bot_api.reply_message(
            event.reply_token,
